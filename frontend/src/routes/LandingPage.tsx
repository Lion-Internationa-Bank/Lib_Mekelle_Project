...
const LandingPage = () => (
  <div className="min-h-screen bg-gradient-to-br from-[#2a2718] to-[#f0cd6e] flex items-center justify-center p-8">
    <div className="max-w-md w-full bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl p-8 text-center border border-white/50">
      <div className="w-24 h-24 bg-gradient-to-r from-[#a68f4e] to-[#6d5f35] rounded-2xl mx-auto mb-8 flex items-center justify-center text-2xl font-bold text-white shadow-lg">
        ML      </div>
      <h1 className="text-4xl font-bold bg-gradient-to-r from-[#2a2718] to-[#6d5f35] bg-clip-text text-transparent mb-4">

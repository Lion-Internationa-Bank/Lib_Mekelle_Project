...
const LandingPage = () => (
  <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-8">
    <div className="max-w-md w-full bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl p-8 text-center border border-white/50">
      <div className="w-24 h-24 bg-linear-to-r from-blue-500 to-indigo-600 rounded-2xl mx-auto mb-8 flex items-center justify-center text-2xl font-bold text-white shadow-lg">
        ML
      </div>
      <h1 className="text-4xl font-bold bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-4">

      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          ...
          <button
            ...
            className="bg-linear-to-r from-[#f0cd6e] to-[#2a2718] hover:from-[#2a2718] hover:to-[#f0cd6e] text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2"
          >
        ...
        {sessions.length === 0 ? (
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-[#f0cd6e]/30 p-8 text-center">
            <div className="w-24 h-24 mx-auto mb-6 bg-linear-to-r from-[#f0cd6e]/30 to-[#2a2718]/30 rounded-full flex items-center justify-center">
            ...
            <button
              onClick={handleCreateNew}
              className="bg-linear-to-r from-[#f0cd6e] to-[#2a2718] hover:from-[#2a2718] hover:to-[#f0cd6e] text-white font-semibold py-3 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
            >
              {t('actions.startNew')}
            </button>
          </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      ...
                      <div>
                        ...
                        <div className="w-full bg-[#f0cd6e]/20 rounded-full h-2.5">
                          <div 
                            className="bg-linear-to-r from-[#f0cd6e] to-[#2a2718] h-2.5 rounded-full transition-all duration-300"
                        ...
                        <button
                          ...
                          className={`flex-1 min-w-35 font-medium py-2.5 px-4 rounded-xl transition-all duration-300 text-center flex items-center justify-center gap-2 ${
                            session.status === "PENDING_APPROVAL"
                              ...
                              : "bg-linear-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 text-white"
                          }`}
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

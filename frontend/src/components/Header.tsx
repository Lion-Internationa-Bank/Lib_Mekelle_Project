      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                <h1 className="text-sm font-bold text-gray-900 leading-tight">Mekelle Land Administration</h1>
                <p className="text-[10px] text-gray-500 font-medium uppercase tracking-wider">City Admin</p>
              </div>
            </div>
          </div>
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-8">
            <div className="relative w-full group">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 bg-gray-50/50 transition-all"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-1.5 pr-2 sm:pr-4 border-r border-gray-200">
              <CalendarToggle />
            ...
            {user && (
              <div className="relative group pl-2">
                <button className="flex items-center gap-3 p-1 rounded-full hover:bg-gray-50 transition-colors">
                  <div className="w-9 h-9 bg-blue-50 rounded-lg flex items-center justify-center text-blue-600 border border-blue-100 shadow-sm">
                    <User className="w-5 h-5" />
                  </div>
                  <div className="hidden lg:block text-left">
                    <p className="text-xs font-semibold text-gray-800 leading-none">{user.full_name}</p>
                    <p className="text-[10px] text-gray-500 mt-1 uppercase tracking-tighter">Authorized</p>
                  </div>
                </button>
